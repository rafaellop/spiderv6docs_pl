...
<ul>
   <li><a href="main_editor.html">tryb edycji kodu źródłowego</a></li>
   <li><a href="main_editor_wysiwyg.html">tryb graficzny (WYSIWYG)</a></li>
</ul></p>
...
<p>Gdy nabierzesz juz trochę wprawy, będziesz rzadziej korzystać z menu i pasków narzędziowych, bowiem większość operacji można wykonać za pomocą skrótów klawiszowych. Skróty te możesz dopasować do własnych potrzeb w oknie <a href="settings_toolbars_hotkeys.html">Ustawień programu</a> </p>
...
<ul>
   <li>z <a href="main_menu_main.html">Menu głównego</a> / <a href="main_menu_file.html">Plik</a> / <a href="main_menu_file_new.html">Nowy dokument</a> - różne typy dokumentów i ich elementów</li>
...
<p>Nowy dokument może być otwierany w <a href="main_editor.html">trybie edycji kodu źródłowego</a>, bądź w <a href="main_editor_wysiwyg.html">trybie graficznym</a>, w zależności od opcji wybranej w <a href="settings_editor_wysiwyg.html">Ustawieniach programu</a>.</p>
...
<ul>
<li>z <a href="main_menu_main.html">Menu głównego</a> / <a href="main_menu_file.html">Plik</a>:
   <ul>
      ...
      <li><a href="tool_open_remote.html">Otwórz z sieci</a> - otwiera narzędzie umożliwiające otworzenie pliku za pomocą sieci.</li>
      <li><a href="tool_importer.html">Importuj</a> - umożliwia import z dysku pliku w formacie nieobsługiwanym bezpośrednio przez Pająka</li>
   </ul>
<li><b>z menu <a href="main_menu_main.html">Menu głównego</a> / <a href="main_menu_services.html">Serwisy</a> / <a href="main_menu_services_properties.html">Własności serwisu</a> / Otwórz często używane serwisu</b> - Otwiera pliki z listy <a href="service_properites.html#servicepropertiesoftenused">często używanych dokumentów serwisu</a>
<li>z listy plików na <a href="main_tabs_myservices.html">zakładce Moje serwisy</a>
<li>z listy plików na zakładce <a href="main_tabs_myftpservers.html">Moje serwery</a> - w Pająku możliwa jest także <a href="network_opendoc_ftp.html">edycja dokumentów otwieranych bezpośrednio z serwera FTP</a>!
...
<ul>
   <li>jak w każdej innej aplikacji Windows za pomocą menu <a href="main_menu_main.html">Menu głównego</a> / <a href="main_menu_file.html">Plik</a> Zapisz, Zapisz jako... i Zapisz wszystkie.</li>
   <li>za pomocą polecenia Zapisz na <a href="toolbars_main.html">Głównym pasku</a></li>
</ul>

<p>Ponadto możesz eksportować dokumenty do formatu HTML lub RTF za pomocą polecenia w <a href="main_menu_main.html">Menu głównym</a> / <a href="main_menu_file.html">Plik</a> Eksportuj. Eksportowanie polega na zapisaniu dokumentu w taki sposób, by przedstawione zostały układ i kolorowanie składni w edytorze Pająka. Pomaga to znacząco przygotowywać listingi kodu do druku itp. </p>

<p>Podczas zapisu dokumentu tworzona są dwa dodatkowe pliki:
<ul>
   <li><a href="main_editor_backups.html">kopia zapasowa</a></li>
   <li><a href="main_editor_addfiles.html">plik dodatkowych informacji dla dokumentu</a></li>
</ul></p>
...
<p>Nazwy aktualnie otwartych dokumentów przedstawiane są na przyciskach u góry edytora (można je przenieść na dół za pomocą zmiany tej opcji w <a href="settings_editor_general.html">Ustawieniach programu</a>. Klikając na odpowiednie przyciski możesz przełączać się między dokumentami. Jeśli przytrzymasz chwilę kursor nad przyciskiem z nazwą dokumentu, pojawi się dymek z pełną ścieżką dostępu do niego. </p>
...
<ul>
   ...
   <li><b>Nowy dokument</b> - tworzy nowy pusty dokument. Dodatkowo polecenie to posiada podmenu identyczne jak analogiczne polecenie w <a href="main_menu_file.html">menu Plik</a>.</li>.  
   ...
   <li><b>Wyświetlaj ścieżkę względem projektu</b> - wyświetla ścieżkę względem <a href="service_properites.html">katalogu głównego serwisu</a> + nazwę pliku</li>
...
<p>W celu szybkiego przełączenia się między dokumentami możesz również skorzystać z poleceń na <a href="toolbars_minitoolbar.html">mini pasku edytora</a>:
<ul>
...
<p>Te same polecenia znajdziesz w <a href="main_menu_main.html">Menu głównym</a> / <a href="main_menu_view.html">Wyświetl</a>.</p>

<p><b>Przełączanie między dokumentami w kolejności użycia</b><br>
Pająk potrafi ułatwić pracę nad wieloma dokumentami dzięki ulepszonej funkcji przełączania się między dokumentami w kolejności ich użycia. Jeśli zaznaczysz opcję o wyżej wymienionej nazwie na planszy <a href="settings_general.html">Ustawienia programu / Ogólne</a> zmienione zostanie zachowanie się programu przy użyciu skrótu klawiszowego <tt>Ctrl+TAB</tt> i <tt>Shift+Ctrl+TAB</tt>. Dokumenty będą przełączane w takiej kolejności, w jakiej ostatnio były edytowane, a nie w kolejności ich otwierania (kolejność na pasku z nazwami plików). Dzięki temu znacznie łatwiej jest przełączać się pomiędzy dwoma dokumentami oddalonymi od siebie na pasku. Mechanizm ten działa wyłącznie podczas korzystania ze skrótów klawiszowych, nie zaś podczas korzystania z poleceń na <a href="toolbars_minitoolbar.html">mini pasku narzędzi</a>!
</p>
...
<ul>
   <li><a href="main_editor.html">Edytor w trybie edycji kodu źródłowego</a>
   <li><a href="main_editor_wysiwyg.html">Edycja w trybie graficznym</a>
