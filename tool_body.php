...
<p>Okienko ustawień sekcji BODY pozwala na określenie własności dla znacznika <tt>&lt;body&gt;</tt>. Znacznik ten określa wygląd tej części strony, która wyświetla informacje. Dlatego ustawienia tej sekcji mają często wpływ na wygląd dokumentu. Jednakże o ile okno to oferuje wiele ustawień, wiele z nich jest już przestarzałych. Obecnie zaleca się stosowanie <a href="coding_css.html">stylów CSS</a> do określania wyglądu dokumentu. Mimo to, opisywane narzędzie może się czasem przydać. 

<p>Okno Ustawień sekcji BODY uruchomisz z poziomu <a href="main_menu_main.html">Menu głównego</a> / <a href="main_menu_tools.html">Narzędzia</a> / <a href="main_menu_tools_structure.html">Struktura</a> / Edytor sekcji &lt;body&gt;, a także z paska narzędzi <a href="toolbars_often.html">Często używane</a> oraz skrótem <tt>Shift+Ctrl+B</tt>. 
...
<p>Znajdujące się w tej grupie ustawienia pozwalają na określenie ustawień marginesów. Niestety, te ustawiania działają wyłącznie w MS Internet Explorer dlatego i w tym wypadku zaleca się korzystanie ze <a href="coding_css.html">stylów CSS</a>. Znajdziesz tutaj następujące ustawienia:
