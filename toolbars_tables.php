...
<!-- nazwa strony pomocy -->
<title>Paski narzędzi - Tabele i formularze</title>
...
<!-- tabelka z trescia -->
        ...
        <table>
        <tr>
                <td><!-- nagłowek głowny tematu -->
                        <h1>Paski narzędzi - Tabele i formularze</h1>
                        <!-- Treść pomocy -->
                        <p>Pasek zawiera zawiera grupy poleceń uruchamiających narzędzia do wstawiania i edycji tabel oraz formularzy.</p>
