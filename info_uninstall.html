...
<!-- nazwa strony pomocy -->
<title>Odinstalowanie programu</title>
...
<h1>Odinstalowanie programu</h1>

<p>Aby usunąć oprogramowanie ze swojego systemu wejdź do grupy w menu Start systemu Windows, w której zainstalowałeś program i wybierz pocyzję "Odinstaluj". Aby uruchomić deinstalator możesz również skorzystać z polecenia "Dodaj/usuń programy", które znajduje się w panelu sterowania Windows.
...
<ul>
    <li><a href="info_install.html">Instalacja programu</a>
