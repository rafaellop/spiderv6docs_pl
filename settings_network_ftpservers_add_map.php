...
Tutaj wpisz adres URL (np. <tt>https://127.0.0.1/pajaczek/</tt>), na który będzie mapowany wybrany wyżej folder. Adres ten będzie używany przy przeglądaniu dokumentów w Pająku, a także przekazywany do przeglądarek w sytuacji wywołania <a href="main_preview_external.html">zewnętrznego podglądu</a>.
...
<p>Przedstawione niżej elementy znajdą się w okienku w sytuacji gdy będziesz tworzyć, bądź edytować mapowanie serwera FTP na adres URL (dla serwera wybranego z listy w oknie <a href="settings_network_ftpservers_add.html" title="Właściwości serwera FTP">Właściwości serwera FTP</a>):
...
<ul>
	<li><a href="settings_network_ftpservers.html">Ustawienia serwerów FTP i WebDAV</a>
	<li><a href="settings_network_ftpservers_add.html">Dodawanie serwera</a>
	<li><a href="services_general.html">Serwisy i korzystanie</a>
