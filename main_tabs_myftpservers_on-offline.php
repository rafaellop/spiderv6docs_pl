...
<p>W tryb online przechodzi się po wybraniu serwera na zakładce <a href="main_tabs_myftpservers.html">Moje serwery</a>, a następnie połączeniu z nim za pomocą przycisku znajdującego się obok listy serwerów. Domyślnie wyświetlana jest zawartość katalogu domowego użytkownika. 
...
<ul>
	...
	<li>Tworzenie nowych katalogów
   	<li><a href="main_tabs_myftpservers_rights.html">Zmiana praw dostępu do plików lub katalogów</a>(tylko na serwerze FTP)
	<li><a href="main_tabs_myftpservers_lockfile.html">Blokowanie, odblokowywanie i informacje o blokadach dokumentów</a>
</ul>

<p>Natomiast operacje publikowania, tj. pobierania bądź wysyłania plików odbywają się za pomocą <a href="down_publishing_ftpqueue.html">kolejki plików</a>, która jest opisana szerzej w innym rozdziale. Kolejka zależnie od ustawień może być wykonywana automatycznie lub nie.
...
<p>W tryb offline przechodzi się po wybraniu serwera na zakładce <a href="main_tabs_myftpservers.html">Moje serwery</a>. O ile plik cache opisany wyżej istnieje, nie trzeba łączyć się z serwerem i od razu można pracować.

<p>W trybie offline lista plików oraz drzewko katalogów są aktywne, ale ikonki elementów są wyszarzone. W ramach zawartości pliku cache, możesz poruszać się po serwerze i wykonywać różne operacje. Operacje te jednak są w większości dodawane do <a href="down_publishing_ftpqueue.html">kolejki plików</a>, aby możliwe było wykonanie wielu funkcji na raz po uzyskaniu połączenia.
...
<p>Pozostałe operacje są dodawane do <a href="down_publishing_ftpqueue.html">kolejki plików serwera</a>, która jest opisana szerzej w innym rozdziale. Po jej uruchomieniu wszystkie zapamiętane operacje zostaną wykonane na serwerze.
