...
<!-- nazwa strony pomocy -->
<title>Wspomaganie dla JavaScript i VBScript - Kolorowanie składni</title>
...
<h1>Wspomaganie dla JavaScript i VBScript - Kolorowanie składni</h1>


<!-- treść pomocy -->


<p>Podstawową pomocą przy pisaniu skryptów JavaScript i VBScript jest <a href="syntax.html">kolorowanie składni</a>. W celu ułatwienia pracy, kolorowania JS i VBS występują w powiązaniu z innymi językami. Dzięki temu możliwe jest np. jednoczesne tworzenie dokumentu HTML z zagnieżdżonymi skryptami. Istnieją oczywiście również schematy kolorowania wyłącznie JS i VBS. 
<ul>
	<li><b>Dynamic HTML</b> - Kolorowanie JavaScript i VBScript, a także HTML i CSS (arkusze stylów)</li>
	<li><b>Dynamic XHTML</b> - Kolorowanie JavaScript i VBScript, a także XHTML (następca HTML) i CSS (arkusze stylów)</li>
	<li><b>HTML + JavaScript</b> - Kolorowanie HTML oraz JavaScript</li>
	<li><b>HTML + VBScript</b> - Kolorowanie HTML oraz VBScript</li>
	<li><b>JavaScript</b> - Kolorowanie wyłącznie JavaScript</li>
	<li><b>VBScript</b> - Kolorowanie wyłącznie VBScript</li>
</ul>
</p>
