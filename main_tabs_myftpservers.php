...
<!-- nazwa strony pomocy -->
<title>Zakładka "Moje serwery"</title>
...
<h1>Zakładka "Moje serwery"</h1>




<p>Zakładka "Moje serwery" pozwala na pracę zdalną na serwerach FTP i WebDAV.
...
<a name="tree"></a>
<h2>Zawartość - Drzewo katalogów</h2>

<p>Drzewo katalogów wyświetla hierarchiczny spis katalogów znajdujących się na na serwerze. Możesz kliknąć nazwę katalogu, aby przełączyć się do niego i zobaczyć jego zawartość na liście poniżej. Możesz również kliknąć plusik, aby rozwinąć katalog i zobaczyć jakie inne katalogi w nim się znajdują. <i>Notka: Pająk na początku nie wie czy w katalogu znajdują się podkatalogi, dlatego plusik jest dostępny zawsze.</i>

<p>Na drzewku możesz wykonać takie operacje, jak usuwanie wybranego katalogu (klawiszem DELETE na wybranym katalogu), zmiana jego nazwy (klawiszem F2 na wybranym katalogu), bądź przeniesienie foldera do innego foldera (bez konieczności pobierania jego zawartości).
...
<p>Na liście plików masz również dostęp do menu podręcznego, w którym znajdują się polecenia pozwalające na operowanie na zawartości zdalnego serwera jak i na widoku listy. Zawartość menu jest identyczna z paskiem przycisków znajdującym się obok listy. Polecenia tam się znajdujące są opisane poniżej.
...
<p><b>Utworzenie nowego folderu</b><br>
To polecenie pozwala na utworzenie na serwerze nowego pustego katalogu.

<p><b>Zmiana nazwy wybranego elementu</b><br>
...
<p><b>Odświeżenie listy plików</b><br>
...
<a name="myftpserverslockfileinfo"></a>
<p><b>Informacje o blokadzie wybranego elementu</b><br>
...
<p><b>Lista ulubionych folderów</b><br>
To menu wyświetla ulubione foldery na serwerze FTP. Ulubione foldery możesz dodawać za pomocą przycisku oznaczonego plusikiem. Wybranie folderu na tej liście powoduje szybkie przejście do niego. Pierwszą pozycją na liście ulubionych jest
pozycja "Przejdź do katalogu domowego", dzięki której szybko przełączysz się do głównego folderu swojego konta.

<p><b>Dodanie bieżącego folderu do listy ulubionych folderów</b><br>
...
<p><b>Filtrowanie plików wg różnych kryteriów</b><br>
...
<p>Aby dowiedzieć się więcej na temat zasad korzystania z zakładki Moje serwery zajrzyj do tematu pomocy poświęconego publikowaniu w Pająku. Znajdziesz tam opis wykorzystania zakładki do różnych zastosowań.

<h2>Status połączenia</h2>
<p>U dołu zakładki znajduje się pasek wyświetlający informację o połączeniu i aktualnie wykonywanej operacji. Informacja składa się z ikony oraz opisu:


<p><b>Rozłączony (offline)</b><br>
