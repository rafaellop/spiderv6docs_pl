...
<!-- nazwa strony pomocy -->
<title>Wyszukiwanie w Pająku</title>
...
<a name="filesearchinfo"></a>
<h2>Wyszukiwanie plików i katalogów</h2>

<p>Możliwość wyszukiwania plików i katalogów jest kolejną funkcją wyszukiwania. Umożliwia wynajdywanie na dysku plików i katalogów spełniających określone kryteria:
<ul>
	<li>wg nazwy lub jej fragmentu</li>
	<li>we wskazanej lokalizacji</li>
	<li>włącznie z podfolderami</li>
	<li>elementów określonej dacie modyfikacji, utworzenia lub dostępu</li>
	<li>o określonym rozmiarze (większy, mniejszy, równy)</li>
	<li>tylko plików lub plików i folderów</li>
