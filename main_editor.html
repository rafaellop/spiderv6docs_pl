...
<p>Tryb edycji kodu źródłowego jest częściej stosowanym trybem edycji w Pająku. Jest też znacznie bardziej rozbudowany i posiada więcej opcji niż <a href="main_editor_wysiwyg.html">tryb graficzny</a>.</p>
...
<p>Ponadto możesz w trybie edycji kodu źródłowego włączyć okno <a href="main_preview_dynamic.html">dynamicznego podglądu</a>.</p>
...
<p>Możesz również <a href="settings_editor_syntax.html">dostosowywać kolorowanie składni</a>, a nawet za pomocą <a href="syntax_editor.html">Edytora schematów kolorowania</a>  edytować istniejące i tworzyć nowe schematy.</p>
...
<p>Takimi właśnie notatkami są w Pająku <a href="main_editor_todotasks.html">Zadania do wykonania</a>. Każde utworzone zadanie przypisane jest do konkretnej linii w konkretnym dokumencie. Linia, w której dodałeś zadanie oznaczona będzie kolorem, który zależy od priorytetu (ważności) zadania (priorytet ustawiasz podczas tworzenia zadania). Kolory poszczególnych priorytetów możesz zmienić korzystając z okna <a href="settings_editor_general.html">Ustawień programu</a></p>
...
<p>Zakładki umożliwiają oznaczenie ważnych miejsc, do których będziesz częściej wracał. Po ustawieniu zakładki w wybranym wierszu, jej ikona pojawi się na <a href="#gutter">rynnie</a>. Więcej o korzystaniu zakładek czytaj <a href="main_editor_bookmarks.html">tutaj</a>.</p>
...
<p>W celu podzielenia okna edytora skorzystaj z polecenia na <a href="toolbars_minitoolbar.html">mini pasku edytora</a>.</p>


<p><b>Podkreślanie błędów</b><br />

<p>Bardzo przydatną funkcją edytora jest podkreślanie błędów w pisowni. Niepoprawnie napisane wyrazy będą oznaczane czerwonym wężykiem (kolor wężyka możesz zmienić w oknie <a href="settings_editor_spelling.html">Ustawień programu</a>). Podkreślanie błędów możesz włączyć lub wyłączyć za pomocą polecenia na <a href="toolbars_minitoolbar.html">mini pasku edytora</a>.</p>
<p>Więcej o sprawdzaniu pisownie <a href="spelling.html">czytaj tutaj</a>.</p>


<p><b>Automatyczne uzupełnianie znaczników, Dynamiczne podpowiedzi, Dynamiczny kod</b><br />


<p>Podczas pracy z dokumentami w różnych językach niejednokrotnie zdarzy Ci się zapomnieć składni jakiegoś elementu (znacznika, funkcji itp.). W takim wypadku z pomocą przychodzą funkcje Dynamicznego kodu. Zostały one szerzej opisane w temacie dotyczącym <a href="main_editor_codeinsight.html">dynamicznego kodu</a>.</p>


<p><b>Menu podręczne</b><br />

<p>Edytor posiada bardzo rozbudowane <a href="main_menu_editor.html">menu podręczne</a> (inaczej nazywane menu kontekstowym). Możesz je wywołać klikając prawym klawiszem myszki w dowolnym miejscu edytora. </p>

<p>Używają poleceń z tego menu możesz wykonać większość operacji w programie, jak np. otwieranie, zapis i zamykanie dokumentów, zmiana schematu kolorowania, <a href="main_editor_navigation.html">nawigacja po dokumencie</a>, zamiana tekstu na tabele, sprawdzanie poprawności pisownie i wiele innych.</p>


<p>Możliwe jest także dostosowanie menu kontekstowego. Najłatwiej można to zrobić klikając polecenie "Dostosuj paski, menu i skróty" znajdujące się u dołu menu podręcznego edytora i w oknie które się otworzy, przejść do kategorii <a href="settings_toolbars_editor.html">Menu kontekstowe edytora</a>.</p>
...
<p>Rynna służy do wyświetlania dodatkowych informacji przydatnych podczas pracy przy edycji kodu. Możesz ją włączyć za pomocą polecenia na <a href="toolbars_minitoolbar.html">mini pasku edytora</a>, lub w oknie <a href="settings_editor_conf.html">Ustawień programu</a>.</p>

<p>Na rynnie mogą się znaleźć następujące elementy:</p>

<ul>
	<li><b>numery linii dokumentu</b> - możesz je włączyć, lub wyłączyć korzystając z polecenia na <a href="toolbars_minitoolbar.html">mini pasku edytora</a>,</li>
	<li><b>ikona zawiniętego wiersza</b> - pojawia się w momencie gdy wiersz nie mieści się w jednym wierszu na ekranie, a jednocześnie włączony jest zawijanie wierszy (zawijanie możesz włączyć i wyłączyć za pomocą polecenia na <a href="toolbars_minitoolbar.html">mini pasku edytora</a>)</li>
	<li><b>ikony zakładek w dokumencie</b> - umożliwiają oznaczenie ważnego miejsca, w celu łatwego jego odnalezienia,</li>
</ul>

<p>Rynna posiada menu, do którego dostęp możesz uzyskać klikając na niej lewym klawiszem myszy. Układ poleceń tego menu jest identyczny, jak w <a href="main_menu_main.html">Menu głównym</a> / <a href="main_menu_edit.html">Edycja</a> / <a href="main_menu_edit_bookmarks.html">Zakładki w dokumencie</a>.</p>
...
<ul>
	...
	<li><a href="main_menu_editor.html">Menu podręczne edytora</a>
