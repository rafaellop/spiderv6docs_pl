...
<!-- nazwa strony pomocy -->
<title>Wspomaganie dla PHP - Kolorowanie składni</title>
...
<h1>Wspomaganie dla PHP - Kolorowanie składni</h1>

<!-- treść pomocy -->



<p>Podstawową pomoc przy pisaniu skryptów PHP jest <a href="syntax.html">kolorowanie składni</a>. Pająk posiada kilka schematów kolorowania dla PHP:
<ul>
   <li><b>HTML+PHP simple</b> - pełne kolorowanie HTML + uproszczony schemat kolorowania PHP (bez nazw funkcji)</li>
   <li><b>HTML+PHP extended</b> - HTML jak wyżej + kolorowanie wszystkich funkcji PHP opisanych w <a href="https://www.php.net/manual/pl/" target="_blank">podręczniku PHP</a> + kolorowanie poleceń systemu automatycznego tworzenia dokumentacji <a href="https://www.phpdoc.org/" target="_blank">phpDocumentor</a> .</li>
   <li><b>HTML+PHP+Smarty</b> - jak  <b>HTML+PHP extended</b> + kolorowanie elementów systemu obsługi szablonów <a href="https://www.smarty.net/" target="_blank">Smarty</a>.</li>
</ul></p>
