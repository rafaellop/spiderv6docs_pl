...
<p>Zakładka "Moje serwisy" służy do pracy z plikami i folderami znajdującymi się na dysku lokalnym. Za pomocą tej zakładki możesz również tworzyć <a href="services_general.html">serwisy</a> i przełączać się między nimi. Widzisz tutaj swoje foldery, pliki, możesz je otwierać, zmieniać nazwy, tworzyć nowe i wiele innych.

<p>Zakładkę Moje serwisy włączysz za pomocą panelu po lewej lub skrótu klawiszowego CTRL+1, a także z menu pod przyciskiem pokazanym powyżej czy z <a href="main_menu_main.html">Menu głównego</a> / <a href="main_menu_view.html">Wyświetl</a>.

<p class="czerwony"> możesz zdefiniować ustawienia tylko jednego serwisu.</p>

<p>W odróżnieniu od zakładki Moje serwisy, zakładka <a href="main_tabs_myftpservers.html">Moje serwery</a> służy do operacji na zdalnych plikach na serwerach FTP.

<h2>Zawartość - Sterowanie serwisami</h2>

<p>W górnej części zakładki Moje serwisy, obok drzewa folderów, znajdziesz zestaw przycisków związanych z <a href="services_general.html">serwisami</a>. Za pomocą tych przycisków możesz tworzyć nowe serwisy, przeglądać własności wybranego serwisu, itd. Zestaw przycisków znajdujący się tutaj jest identyczny z <a href="main_menu_main.html">Menu głównym</a> / <a href="main_menu_services.html">Serwisy</a> i tam znajdziesz opis działania znajdujących się tutaj poleceń.
...
<p>Pod drzewkiem folderów znajduje się lista plików, która w zależności od <a href="settings_filelist.html">ustawień</a> wyświetla zarówno foldery i pliki lub wyłącznie pliki znajdujące się w bieżącym folderze. Lista plików jest identyczna z tą znaną z eksploratora Windows ma jednak dużo więcej funkcji.
...
<p><b>Importuj</b><br>
To narzędzie pomoże Ci zaimportować i przekształcić na strony WWW dokumenty różnego typu, w tym dokumenty obsługiwane przez pakiet Office, dokumenty RTF, pliki baz danych CSV i pliki tekstowe. Import opisany jest szerzej w opisie <a href="tool_importer.html">Importera plików</a>.

<p><b>Podgląd</b><br>
Za pomocą tego polecenia możesz przeglądać dokumenty HTML na <a href="main_preview_embed.html">podglądzie wbudowanym</a> w Pająka.

<p><b>Szybki podgląd</b><br>
To polecenie uruchamia narzędzie <a href="tool_quickpreview.html">Szybki podgląd</a>, za pomocą którego możesz przeglądać pliki różnego typu, np. grafiki, dźwięki, filmy, dokumenty HTML i inne.

<p><b>Wstaw odnośnik</b><br>
To polecenie uruchamia okno <a href="tool_link.html">Wstawianie odnośnika</a>, za pomocą którego możesz wstawić do aktualnie edytowanego dokumentu odsyłacz do pliku wybranego na liście.

<p><b>Informacje o dokumencie</b><br>
To polecenie uruchamia okno <a href="tool_docinfo.html">Informacje o dokumencie</a>, w którym masz dostęp do wielu informacji powiązanych z wybranym na liście plikiem.
...
Kliknij, aby przywrócić ostatnią zapisaną zawartość pliku z kopii zapasowej. Polecenie to dostępne jest jedynie dla plików posiadających <a href="main_editor_backups.html">kopie zapasową</a>.
...
To jest przełącznik, który powoduje przypisanie do podręcznego menu listy plików menu systemowego jak w eksploratorze Windows. Jeśli przełącznik jest wyłączony, używane jest menu Pająka. Włączenie menu systemowego jest konieczne, jeśli chcesz korzystać z funkcji <a href="how_tousecvs.html">wsparcia dla CVS</a>.

<!-- dodane w 5.6 -->
<p><b>Ukrycie paska przycisków listy plików</b><br>
To jest przełącznik, który powoduje wyłączenie lub włączenie wyświetlania pasków przycisków umieszczonych obok listy plików i drzewa folderów (wyżej). Identyczne polecenie ("Ukryj pasek przycisków listy plików i drzewa katalogów") znajdziesz również w oknie <a href="settings_filelist.html">Ustawienia programu - Lista plików</a>.

<p><b>Konwertuj znaki narodowe na ...</b><br>
To polecenie uruchamia narzędzie <a href="charset_encoding.html">Konwersji znaków narodowych</a> w aktualnym folderze.

<p><b>Wyszukaj lub wyszukaj lub zamień</b><br>
To polecenie uruchamia narzędzie <a href="find_ext.html">Rozszerzonego wyszukiwania i zamiany</a> w aktualnym folderze.
...
Za pomocą tego polecenia możesz dodać wybrany plik (CSS, JS lub PHP) do listy plików, które są wirtualnie dołączane do każdego dokumentu  składowego projektu. Więcej o <a href="service_virtual_include.html">wymuszonym dołączaniu</a>.
...
<ul>
   ...
   <li><a href="service_properites.html">Okno Właściwości serwisu</a></li>
   <li><a href="settings_filelist.html">Ustawienia listy plików</a>
