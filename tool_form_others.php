...
<p><p>Narzędzie uruchomisz z poziomu <a href="main_menu_main.php">Menu głównego</a> / <a href="main_menu_tools.php">Narzędzia</a> / <a href="main_menu_tools_forms.php">Formularze</a> / Inne elementy formularza, lub z paska <a href="toolbars_tables.php">Tabele i formularze</a>. Ikona polecenia została pokazana obok.
...
Podaj adres URL do obrazka (tylko przycisk graficzny). Możesz skorzystać z listy, na której znajdują się ostatnio adresy do używanych obrazków, bądź z przycisku obok pola, który otwiera <a href="tool_graphic_browser.php">przeglądarkę grafik</a>.
